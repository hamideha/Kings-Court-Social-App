    ...
    return (
        <>
            <div className="flex justify-center">
                <div className="border border-grey-light bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal w-full md:w-1/2">
